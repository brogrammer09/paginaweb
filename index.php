...
<html lang="en">
    ...
    <body>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h1>Bienvenido</h1>
                            <span class="subheading">Esta es mi página personal</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div>
            <h1><center>Esta es una página personal</center></h1>
            <p>
                <center>Esta página es una página para darme a conocer como programador se bienvenido y que puedas ver los apartados de información sobre mi </center>
                <br><center>en ella podemos encontrar mi Curriculum un video y un poco de información acerca de mi</center>
            </p>
        </div>      
        <div class="embed-responsive embed-responsive-16by9" style="margin-left: 600px;">
            <iframe class="embed-responsive-item" src="https://youtu.be/6j6-jGc-MRQ" allowfullscreen></iframe>
        </div>
